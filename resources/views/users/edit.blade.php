                    ...
                    <div class="card overflow-hidden rounded-2 box-shadow-1">
                        <div class="card-content">
                            <div class="media align-items-stretch">
                                <div class="bg-amber p-2 media-middle" style="border-top-left-radius: 0.5em;border-bottom-left-radius: 0.5em">
                                    <i class="fa fa-pencil-square font-large-2 text-white"></i>
                                </div>
                                <div class="media-body p-1">
                                    <span class="amber font-medium-5 text-bold-700">Perubahan Data Akun</span><br>
