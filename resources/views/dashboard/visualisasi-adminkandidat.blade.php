            ...
            <div class="card-content">
                <div class="card-body text-center">
                    <div class="p-1 text-center">
                        <div>
                            <h3 class="font-large-1 grey darken-1 text-bold-400">{{$jumlah_dpt}}</h3>
                            <span class="font-small-3 grey darken-1">Total Pendukung</span>
                        </div>
                        <div class="card-content overflow-hidden">
                            ...
                            <ul class="list-inline clearfix mb-0">
                                <li class="border-right-grey border-right-lighten-2 pr-2">
                                    <h3 class="blue text-bold-400">{{$totalPendukungLakilaki}}</h3>
                                    <span class="font-small-3 grey darken-1"><i class="ft-chevron-up success"></i> Laki-laki</span>
                                </li>
                                <li class="pl-2">
                                    <h3 class="red text-bold-400">{{$totalPendukungPerempuan}}</h3>
            ...
            <div class="card-content">
                <div class="card-body text-center">
                    <div class="card-header mb-2">
                        <span class="green darken-1">Total Relawan</span>
                        <h3 class="font-large-2 grey darken-1 text-bold-200">{{$jumlah_relawan}}</h3>
                    </div>
                    <div class="card-content">
                        ...
                        <ul class="list-inline clearfix mt-2 mb-0">
                            <li class="border-right-grey border-right-lighten-2 pr-2">
                                <h2 class="grey darken-1 text-bold-400">{{$totalRelawanLakilaki}}</h2>
                                <span class="blue">Laki-laki</span>
                            </li>
                            <li class="pl-2">
                                <h2 class="grey darken-1 text-bold-400">{{$totalRelawanPerempuan}}</h2>
        ...
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    <div class="media">
                        <div class="media-body text-left">
                            <h3 class="blue">{{$relawanNow}}</h3>
                            <span>+ Relawan hari ini</span>
                        </div>
                        <div class="media-right media-middle">
                            <i class="ft-users blue font-large-2 float-right"></i>
                        </div>
                    </div>
                    <div class="progress mt-1 mb-0" style="height: 7px;">
                        <div class="progress-bar bg-blue" role="progressbar" style="width: 35%" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
            </div>
        </div>
