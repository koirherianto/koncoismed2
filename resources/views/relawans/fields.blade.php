<div class="card rounded-2 box-shadow-1 mb-5">
    <div class="card-content">
        <div class="card-body">
            <div class="font-medium-2 text-bold-800 black mb-2"><i class="fa fa-pencil-square pr-1 blue"></i> DATA AKUN</div>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('no_kta', null, ['class' => 'form-control border-left-pink border-left-6 text-bold-600 black font-medium-2']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('nik', null, ['class' => 'form-control border-left-pink border-left-6 text-bold-600 black font-medium-2']) !!}
                        </div>
                    </div>
                    <div class="col-6">
                        <!-- Jenis Kelamin Field -->
                        <div class="form-group">
                            ...
                            {!! Form::select('jenis_kelamin', [''=>'Pilih','Laki-laki'=>'Laki-Laki','Perempuan'=>'Perempuan'],null, ['class' => 'form-control border-left-pink border-left-6 text-bold-600 black font-medium-2']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('tempat_lahir', null, ['class' => 'form-control border-left-pink border-left-6 text-bold-600 black font-medium-2']) !!}
                        </div>
                    </div>
                    <div class="col-6">
                        <!-- Tanggal Lahir Field -->
                        <div class="form-group">
                            ...
                            {!! Form::date('tanggal_lahir', null, ['class' => 'form-control border-left-pink border-left-6 text-bold-600 black font-medium-2','id'=>'tanggal_lahir']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-13">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('status_perkawinan', [''=>'Pilih', 'Pernah'=>'Pernah','Sudah'=>'Sudah', 'Belum'=>'Belum'],null, ['class' => 'form-control border-left-pink border-left-6 text-bold-600 black font-medium-2']) !!}
                    </div>
                </div>
            @push('page_scripts')
            ...
            @endpush
                ...
                <div class="col-12">
                    <div class="card box-shadow-0-1 mt-1">
                        <div id="heading1" class="card-header rounded-2 border-left-6 border-left-blue box-shadow-0-1 cursor-pointer" role="tab" data-toggle="collapse" data-parent="#accordionWrapa1" href="#steap1">
                            <a data-toggle="collapse" data-parent="#accordionWrapa1" href="#steap1" aria-expanded="false" aria-controls="accordion1" class="font-medium-2 text-bold-800 black text-uppercase">
                                <i class="fa fa-lock blue mr-1"></i> Kata Sandi Akun
                            </a>
                        </div>
