             ...
             <div class="row g-0 justify-content-center position-relative">
               <div class="col-lg-4 col-md-6 login-fancy-bg bg-overlay-black-30" style="background: url(images/login/02.jpg);">
                 <div class="login-fancy pos-r">
                  <h2 class="text-white mb-20">Caleg Web App</h2>
                  <p class="mb-20 text-white">Caleg akan membantu Calon Legislatif untuk menentukan alat ukur pemenangan secara kualitatif dan kuantitatif untuk memaksimalkan gerakan Pemenangan Calon Legislatif dengan cara yang cerdas.</p>
               ...
               <div class="col-lg-6 col-md-6 white-bg">
                ...
                <div class="row">
                  ...
                  @enderror
                  <div class="section-field mb-20 col-sm-6">
                    <label class="mb-10" for="contact">No Hp</label>
                      <input id="contact" class="form-control @error('contact') is-invalid @enderror" type="text" placeholder="08xxxxxxxxxx" name="contact"value="{{ old('contact') }}">
                   </div>
                </div>
                 <div class="row">
                  <div class="section-field mb-20 col-sm-6">
                    <label class="mb-10" for="email">Email* </label>
                    <input id="contact" class=" form-control @error('email') is-invalid @enderror" type="text" placeholder="Email" name="email"  value="{{ old('email') }}">
                   </div>
                   <div class="section-field mb-20 col-sm-6">
                    <label class="mb-10" for="alamat">Alamat* </label>
                    <input id="contact" class=" form-control @error('alamat') is-invalid @enderror" type="text" placeholder="Alamat" name="alamat"  value="{{ old('alamat') }}">
                   </div>
                 </div>
                ...
                <div class="section-field mb-20 col-sm-9">
                  <div class="d-flex">
                  <div class="captcha ">
                  ...
                  {{-- <button type="button" class="btn btn-danger ml-20 col-sm-1" class="reload" id="reload">
                    &#x21bb;
                      ...
                      <input id="captcha" maxlength="8" type="text" class="form-control font-small-4 ml-20 col-sm-12" placeholder="Masukkan Captcha" name="captcha">
                  </div>
