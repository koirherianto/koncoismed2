    ...
    <div class="navbar-wrapper">
      <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item"><a class="navbar-brand" href="{{('/')}}"><img class="brand-logo" alt="robust admin logo" src="{{asset('master\app-assets\images\logo\logo-kaltim-icon.png')}}">
            ...
            {{-- <li class="dropdown nav-item mega-dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown">Mega</a>
              <ul class="mega-dropdown-menu dropdown-menu row">
                ...
                <li class="col-md-3">
                  ...
                  <ul class="drilldown-menu sliding-menu" style="height: 210.667px;"><div class="sliding-menu-wrapper" style="width: 638.499px;"><ul id="menu-panel-od3mx" class="menu-panel-root" style="width: 212.833px;">
                        <li><a class="dropdown-item" href="layout-2-columns.html"><i class="ft-file"></i> Page layouts &amp; Templates</a></li>
                        <li><a href="#menu-panel-bdgdt" class="nav-has-children dropdown-item"><i class="ft-align-left"></i> Multi level menu<i class="ft-arrow-right children-in"></i></a>
                        ...
                        <li><a class="dropdown-item" href="https://pixinvent.ticksy.com/"><i class="fa fa-life-ring"></i> Customer support center</a></li>
                      </ul><ul id="menu-panel-bdgdt" class="menu-panel" style="width: 212.833px;"><a class="nav-has-parent back primary dropdown-item" href="#menu-panel-back"></a>
                            <li><a class="dropdown-item" href="#"><i class="fa fa-file-o"></i>  Second level</a></li>
                            <li><a href="#menu-panel-n7w00" class="nav-has-children dropdown-item"><i class="fa fa-star-o"></i> Second level menu<i class="ft-arrow-right children-in"></i></a>
                          ...
                          </ul><ul id="menu-panel-n7w00" class="menu-panel" style="width: 212.833px;"><a class="nav-has-parent back primary dropdown-item" href="#menu-panel-back"></a>
          ...
          <ul class="nav navbar-nav float-right">         
            ...
            <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-bell"></i><span class="badge badge-pill badge-default badge-danger badge-default badge-up">5</span></a>
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                ...
                <li class="scrollable-container media-list w-100 ps-container ps-theme-dark ps-active-y" data-ps-id="9c1a9ab6-8d46-365a-1a8b-e2b9eed592bd"><a href="javascript:void(0)">
                    <div class="media">
                    ...
                    </div></a><div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 3px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 255px; right: 3px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 160px;"></div></div></li>
            ...
            <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-mail"></i><span class="badge badge-pill badge-default badge-info badge-default badge-up">5              </span></a>
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                ...
                <li class="scrollable-container media-list w-100 ps-container ps-theme-dark ps-active-y" data-ps-id="1d0e63a8-b42d-d3c7-7615-fdbbb1815ffa"><a href="javascript:void(0)">
                    <div class="media">
                    ...
                    </div></a><div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 3px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 255px; right: 3px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 187px;"></div></div></li>
            ...
            <i></i></span><span class="user-name">{!! Auth::user()->name !!}</span></a>
              <div class="dropdown-menu dropdown-menu-right">
                <a class="dropdown-item" href="{!! url('/profil') !!}"><i class="ft-user"></i> Edit Profile</a>
                ...
                <a class="dropdown-item" href="<a href="{!! url('/logout') !!}"
            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="{{('/')}}">
                        <img alt="robust admin logo" src="{{asset('image/britech.png')}}" height="45">
                    </a>
                </li>
